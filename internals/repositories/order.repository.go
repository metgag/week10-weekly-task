...
func (o *OrderRepository) CreateOrder(ctx context.Context, body models.CinemaOrder) (string, error) {
	sql := `
		INSERT INTO
	...
	ctag, err := o.dbpool.Exec(ctx, sql, body.UID, body.ScheduleID, body.PaymentMethod, body.Total, body.IsPaid)
	if err != nil {
		return "", err
	}
